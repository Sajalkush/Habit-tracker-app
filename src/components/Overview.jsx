...
const Overview = () => {
    ...
    <>
      ...
      <ListGroup>
        {habits.map((habit, index) => (
          <ListGroup.Item key={index} className='mb-1 rounded habit-container' style={{ background: 'rgb(243 156 18 / 79%)' }}>
  ...
  style={{ backgroundColor: 'rgb(201 32 32)' }}
  onClick={() => setModalShow(true)}
>
  <i className='fa-solid fa-circle-plus'></i> &nbsp;&nbsp; Add a habit
</Button>
